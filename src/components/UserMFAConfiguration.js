...
class UserMFAConfiguration extends Component {
  constructor() {
    super();
  ...
  remove2FA(method) {
    ...
    this.resetRequests();
    const action = (data = {}) => disableFAregistration({ ...data, method })
      .then(() => {
        this.props.getEnabledAuth();
      })
      .then(() => {
  ...
  regenerateBackupCodes() {
    ...
    this.resetRequests();
    const action = (data) => regenerateBackupCodes({ ...data, method })
  ...
  changePrimaryMethod(event, method) {
    this.resetRequests();
    const action = (data) => changePrimaryMethod({ ...data, method })
...
export default UserMFAConfiguration;
