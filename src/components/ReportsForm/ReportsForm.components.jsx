...
export default function ReportsForm() {
  ...
  const fetchTransactions = (asaId='13672793') => {
    console.log(asaId);
    axios.get('https://api.testnet.algoexplorer.io/idx2/v2/assets/' + asaId + '/transactions?limit=10')
    .then((response) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <input type="text" placeholder="Account" name="Account" ref={register({maxLength: 52})} />
      <input type="number" placeholder="Balance min" name="Balance min" ref={register} />
      <input type="number" placeholder="Balance max" name="Balance max" ref={register} />
